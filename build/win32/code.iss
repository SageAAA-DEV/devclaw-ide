...
AppPublisher=SageAAA
AppPublisherURL=https://www.sageaaa.com/
AppSupportURL=https://www.sageaaa.com/
AppUpdatesURL=https://www.sageaaa.com/
DefaultGroupName={#NameLong}
AllowNoIcons=yes
OutputDir={#OutputDir}
OutputBaseFilename=DevClawSetup
Compression=lzma
